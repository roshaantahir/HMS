<html>
	<head>
		...
		*[contenteditable]:hover, *[contenteditable]:focus, td:hover *[contenteditable], td:focus *[contenteditable], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
		...
		header address { float: left; padding-top: 38px; font-size: 75%; font-style: normal; line-height: 1.25; margin: 0 1em 1em 0; }
		header address p { margin: 0 0 0.25em; }
		header span, header img { display: block; float: right; }
		header span { margin: 0 0 1em 1em; max-height: 25%; max-width: 60%; position: relative; }
		header img { max-height: 100%; max-width: 34%; }
	...
	<body>
		...
		<header>
			...
			<address >
				...
				<p>SIALKOT ROAD,<br>GUJRANWALA.</p>
				<p>+92 323 7446367</p>
			</address>
			<span><img alt="" src="assets/img/pak.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- email@pakhotels.com || Web :- www.pakhotels.com || Phone :- +92 323 7446367 </p>
			</div>
		</aside>
	</body>
</html>
